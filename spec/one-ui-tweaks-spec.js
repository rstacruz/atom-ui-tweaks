...
import OneUiTweaks from '../lib/one-ui-tweaks';
...
describe('OneUiTweaks', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('one-ui-tweaks');
  });
  ...
  describe('when the one-ui-tweaks:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let oneUiTweaksElement = workspaceElement.querySelector('.one-ui-tweaks');
