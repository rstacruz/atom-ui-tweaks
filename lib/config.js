...
export const EDITOR_CONFIG = {
  ...
  forceCommentFontStyle: {
    ...
    description: '👌 *New* &mdash; Force comments to be italic (or not), regardless of syntax theme',
    type: 'string',
    default: 'default',
    enum: [
  ...
  cursorLineStyle: {
    ...
    description: '👌 *New* &mdash; Adjust the highlight of the current line. *Disabled* will turn it off, while *Brighten* will adjust text brightness instead of adding a background. 🔥 *Recommended!*',
    type: 'string',
    default: 'default',
    enum: [
...
export const UI_CONFIG = {
  compactFuzzyFinder: {
    ...
    description:
      'A compact view for the fuzzy finder (Ctrl+P). Shows more lines by changing the default two-line display into one-line. Requires the `fuzzy-finder` core extension. 🔥 *Recommended!*'
  },

  hideFindAndReplaceCloseButton: {
    ...BOOL,
    title: 'Hide "Find and Replace" close button',
    description: 'Hide the close button on Ctrl+F; use `Esc` to close instead. Applies to the find (ctrl-f) and find in project (ctrl-shift-f) panels'
  },
  ...
  atomLogoSplashScreen: {
    ...
    description: '👌 *New* &mdash; Show artwork when there are no editors open. Only works with the `background-tips` core package'
  }
}
...
export const MODAL_CONFIG = {
  disableAnimation: {
    ...
    description:
      '👌 *New* &mdash; Show modal dialogs instantly without fading in the overlay screen. Gives the impression of a faster, more responsive UI.'
  },

  simplifyBackdrop: {
    ...BOOL,
    title: 'Simplify backdrop',
    description: '👌 *New* &mdash; Fade the editor out instead of dimming the entire screen.'
  }
}
