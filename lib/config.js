...
export const EDITOR_CONFIG = {
  ...
  cursorLineStyle: {
    ...
    description: 'Adjust the highlight of the current line. *Disabled* will turn it off, while *Brighten* will adjust text brightness instead of adding a background',
    type: 'string',
    default: 'default',
    enum: [
