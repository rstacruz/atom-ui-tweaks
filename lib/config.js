...
export const EDITOR_CONFIG = {
  ...
  forceCommentFontStyle: {
    ...
    description: `${NEW} Force comments to be italic (or not), regardless of syntax theme`,
    type: 'string',
    default: 'default',
    enum: [
...
export const UI_CONFIG = {
  ...
  atomLogoSplashScreen: {
    ...
    description: `${NEW} Show artwork when there are no editors open. Only works with the \`background-tips\` core package`
  }
}
...
export const TAB_CONFIG = {
  ...
  style: {
    title: 'Style',
    description: `${NEW} Change the style of the tab bar ${EXPERIMENTAL}`,
    type: 'string',
    default: 'default',
    enum: [
...
export const FIND_IN_PROJECT_CONFIG = {
  subtleHeaderRows: {
    ...
    description: `${NEW} Make filenames easier to see`
  },

  subtleMatchCount: {
    ...BOOL,
    title: 'Subtle match count',
    description: `${NEW} Make the '11 matches' text less distracting`
  },

  subtleHighlights: {
    ...BOOL,
    title: 'Subtle highlights',
    description: `${NEW} Make highlighted text easier to read ${RECOMMENDED}`
  },

  subtleLineNumbers: {
    ...BOOL,
    title: 'Subtle line numbers',
    description: `${NEW} Make line numbers align properly, and make their font sizes a bit smaller`
  },

  subtleSeparators: {
    ...BOOL,
    title: 'Subtle separators',
    description: `${NEW} Lessen the opacity of the lines separating each result`
  }
}
